...
def test_mask_phone_numbers():
    assert (mask_phone_numbers("Мой номер: +79112345678, позвоните мне, пожалуйста.") ==
            "Мой номер: +7911234XXXX, позвоните мне, пожалуйста.")
    assert (mask_phone_numbers("Звоните по телефону +79115556677 или пишите на номер +79118887766.") ==
